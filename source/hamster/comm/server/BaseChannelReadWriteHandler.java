 ...
 *
 */
abstract class BaseChannelReadWriteHandler implements ReadTargetListener, WriteChannelHandler, SocketChannelController, BaseChannelOptionController
{
  /**
  ...
  /**
   * <p>
   * Construct an instance of {@link BaseChannelReadWriteHandler}.
   * 
   ...
   */
  BaseChannelReadWriteHandler(SelectionKey selKey, NetworkChannel channel, SocketChannelListener channelListener, Logger logger)
  {
    this.selKey = selKey;
   ...
   */
  protected int handleReadIOException(IOException e)
  {
    // Log this.
   ...
   */
  protected abstract int handleReadData(int i) throws IOException;
//  {
...
//      int res = targetBuffer.fromChannel(channel);
//    
...
//    {
//      //Fill the buffer from the incoming channel buffer.
//      int res = targetBuffer.fromChannel(channel, maxBytesToFill);
//    
//      //Handle the read data.
//      res = handleReadData(res);
//      
